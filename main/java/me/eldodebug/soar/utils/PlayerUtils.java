...
public class PlayerUtils {
	...
	public static boolean hasItem(Item item) {
		...
		if (mc.thePlayer == null || mc.thePlayer.inventory == null || item == null) {
			return false;
		}
	...
	public static int getPotionsFromInventory(Potion inputPotion) {
		...
		if (mc.thePlayer == null || mc.thePlayer.inventoryContainer == null || inputPotion == null) {
			return 0;
		}
				...
				if (item instanceof ItemPotion) {
					...
					if (potion.getEffects(is) != null) {
						...
						while (iterator.hasNext()) {
							...
							if (effect != null && effect.getPotionID() == inputPotion.id) {
								++count;
							}
						}
					}

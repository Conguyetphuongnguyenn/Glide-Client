...
public enum TranslateText {
	...
	ASYNC_SCREENSHOT_DESCRIPTION("text.asyncscreenshot.description"), MESSAGE("text.message"), 
	
	// ✅ MUSIC SYSTEM KEYS (ADDED)
	...
	ALL("text.all"), FAVORITE("text.favorite"), FREELOOK("text.freelook.name"),
	...
	HORSE_STATS("text.horsestats.name"), HORSE_STATS_DESCRIPTION("text.horsestats.description"), 
	
	KILL_EFFECTS("text.killeffects.name"), KILL_EFFECTS_DESCRIPTION("text.killeffects.description"), 
	BLOOD("text.blood"), LIGHTING("text.lighting"), FLAMES("text.flames"),
	EXPLOSION("text.explosion"), HEARTS("text.hearts"), CRITICAL("text.critical"), 
	NOTES("text.notes"), PORTAL("text.portal"), SLIME("text.slime"), 
	FIREWORK("text.firework"), ENDER("text.ender"), RANDOM("text.random"),
	CLOUD("text.cloud"), SOUND("text.sound"), EFFECT("text.effect"), 
	
	NAMETAG("text.nametag.name"), NAMETAG_DESCRIPTION("text.nametag.description"),
	...
	THEME("text.theme"), GLOW("text.glow"), OUTLINE_GLOW("text.outlineglow"), VANILLA_GLOW("text.vanillaglow"), RECT("text.rect"), 
	ENGLISH_US("text.englishus"), ENGLISH_GB("text.englishgb"), FRENCH("text.french"),
	...
	BLACK_SMOKE("text.blacksmoke"), FIRE("text.fire"), GREEN_STAR("text.greenstar"), 
	MAGIC("text.msgic"), MUSIC_NOTES("text.musicnotes"),
	SPARK("text.spark"), SWIRL("text.swirl"), WHITE_SMOKE("text.whitesmoke"), SKIN_PROTECT("text.skinprotect.name"),
	...
	SOUND_MODIFIER_DESCRIPTION("text.soundmodifier.description"), TNT("text.tnt"), NOTE("text.note"), 
	MOBS("text.mobs"), STEP("text.step"),
	...
	PARTICLE_CLEANER("text.particlecleaner.name"), PARTICLE_CLEANER_DESCRIPTION("text.particlecleaner.description"), 
	DISTANCE_CLEAN("text.distanceclean"), LIMIT_PARTICLES("text.limitparticles"), MAX_PARTICLES("text.maxparticles"),
	...
	HIDE_THIRD_PERSON_VIEW("text.hidethirdpersonview"), CUSTOM_CROSSHAIR("text.customcrosshair"), RED_ON_TARGET("text.red_on_target"), SCALE("text.scale"), OVERLAY_EDITOR("text.overlayeditor.name"), OVERLAY_EDITOR_DESCRIPTION("text.overlayeditor.description"),
	...
	// Main Menu
	MAIN_MENU("text.mainmenu"),
	SINGLEPLAYER_SUBTITLE("text.singleplayer.subtitle"),
	MULTIPLAYER_SUBTITLE("text.multiplayer.subtitle"),
	SETTINGS_SUBTITLE("text.settings.subtitle"),

	// Recent Activity
	NO_RECENT("text.norecent"),
	NO_RECENT_SUBTITLE("text.norecent.subtitle"),

	// News
	NEWS_OPTIMIZED("text.news.optimized"),
	NEWS_PERFORMANCE("text.news.performance"),
	NEWS_PERFORMANCE_SUB("text.news.performance.sub"),
	NEWS_SEARCH("text.news.search"),
	NEWS_SEARCH_SUB("text.news.search.sub"),

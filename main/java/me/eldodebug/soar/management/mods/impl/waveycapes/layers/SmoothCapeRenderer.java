...
public class SmoothCapeRenderer {
    ...
    public void renderSmoothCape(CustomCapeRenderLayer layer, AbstractClientPlayer abstractClientPlayer, float delta) {
        ...
        for (int part = 0; part < CustomCapeRenderLayer.partCount; part++) {
            ...
            if (part == 0) {
                addTopVertex(worldrenderer, poseStack.last().getPose(), oldPositionMatrix,
                        0.3F,
                        0,
                        0F,
                        -0.3F,
            ...
            if (part == CustomCapeRenderLayer.partCount - 1) {
                addBottomVertex(worldrenderer, poseStack.last().getPose(), poseStack.last().getPose(),
                        0.3F,
            ...
            addLeftVertex(worldrenderer, poseStack.last().getPose(), oldPositionMatrix,
                    -0.3F,
                    (part + 1) * (0.96F / CustomCapeRenderLayer.partCount),
                    0F,
                    -0.3F,
            ...
            addRightVertex(worldrenderer, poseStack.last().getPose(), oldPositionMatrix,
                    0.3F,
                    (part + 1) * (0.96F / CustomCapeRenderLayer.partCount),
                    0F,
                    0.3F,
            ...
            addBackVertex(worldrenderer, poseStack.last().getPose(), oldPositionMatrix,
                    0.3F,
                    (part + 1) * (0.96F / CustomCapeRenderLayer.partCount),
                    -0.06F,
                    -0.3F,
            ...
            addFrontVertex(worldrenderer, oldPositionMatrix, poseStack.last().getPose(),
                    0.3F,
                    (part + 1) * (0.96F / CustomCapeRenderLayer.partCount),
                    0F,
                    -0.3F,

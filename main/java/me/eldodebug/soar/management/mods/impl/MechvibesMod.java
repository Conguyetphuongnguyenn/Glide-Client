...
public class MechvibesMod extends Mod {
    ...
    private enum KeyboardType {
        ...
        MX_BLUE("mx_blue"),
        MX_SILVER("mx_silver"),
        RAZER_GREEN("razer_green"),
        HYPERX_AQUA("hyperX_aqua"),
        MX_BLACK("mx_black"),
        TOPRE_PURPLE("topre_purple");
        
        private final String id;
        
        KeyboardType(String id) {
            this.id = id;
        }
    ...
    public void setup() {
        ...
        this.keyTypeSetting = new ComboSetting(TranslateText.TYPE, this, TranslateText.NK_CREAM, 
            new ArrayList<Option>(Arrays.asList(
                new Option(TranslateText.NK_CREAM), 
                new Option(TranslateText.MX_BLUE),
                new Option(TranslateText.MX_SILVER), 
                new Option(TranslateText.RAZER_GREEN),
                new Option(TranslateText.HYPERX_AQUA), 
                new Option(TranslateText.MX_BLACK), 
    ...
    private void updateVolumes() {
        ...
        if (Math.abs(cachedKeyboardVolume - newKeyboardVol) > EPSILON) {
            ...
            for (SoundKey key : keyMap.values()) {
                if (key != null) {
                    key.setVolume(cachedKeyboardVolume);
                }
            }
        }
        ...
        if (Math.abs(cachedMouseVolume - newMouseVol) > EPSILON) {
            ...
            if (mouseLeftSound != null) {
                mouseLeftSound.setVolume(cachedMouseVolume);
            }
            if (mouseRightSound != null) {
                mouseRightSound.setVolume(cachedMouseVolume);
            }
        }
    }
    ...
    private void handleMouseInput() {
        ...
        try {
            ...
            if (leftDown != mouseLeftPress) {
                if (leftDown && mouseLeftSound != null) {
                    mouseLeftSound.play();
                }
            ...
            if (rightDown != mouseRightPress) {
                if (rightDown && mouseRightSound != null) {

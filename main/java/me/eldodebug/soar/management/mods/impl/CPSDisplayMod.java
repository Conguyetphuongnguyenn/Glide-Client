...
public class CPSDisplayMod extends SimpleHUDMod {
	...
	private ArrayList<Long> leftPresses = new ArrayList<>(20);
	private ArrayList<Long> rightPresses = new ArrayList<>(20);
	...
	public void onClickMouse(EventClickMouse event) {
		if(Mouse.getEventButtonState()) {
			...
			if(event.getButton() == 1) rightPresses.add(System.currentTimeMillis());
		}
	}

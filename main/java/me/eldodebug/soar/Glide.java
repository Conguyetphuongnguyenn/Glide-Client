...
import me.eldodebug.soar.management.screenshot.WorldScreenshotManager;
...
public class Glide {
	...
	private WorldScreenshotManager worldScreenshotManager;
	...
	public void start() {
		...
		worldScreenshotManager = new WorldScreenshotManager();
	...
	public WorldScreenshotManager getWorldScreenshotManager() {
		return worldScreenshotManager;
	}
	...
	public boolean getSoar8Released() {
		return soar8Released;
	}
